...
//   const letters = "01234456789ABCDEF";
//   let hash = "#";
//   for (let i = 0; i < 6; i++) {
...
function colorizeSliders(color, hue, brightness, saturation) {
  ...
  hue.style.backgroundImage = `linear-gradient(to right,rgb(204,75,75),rgb(204,024,75),rgb(75,204,75),rgb(75,204,204),rgb(75,75,204),rgb(204,75,204),rgb(204,75,75))`;
}
